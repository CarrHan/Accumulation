package com.hsh.baselib.widget.slidingUpPanel;
...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    /**
     * Default attributes for include_review_order_content
     */
    ...
    /**
     * The paint used to dim the main include_review_order_content when sliding
     */
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        if (mShadowHeight > 0) {
            if (mIsSlidingUp) {
                mShadowDrawable = getResources().getDrawable(R.drawable.slide_up_above_shadow);
            } else {
                mShadowDrawable = getResources().getDrawable(R.drawable.slide_up_below_shadow);
            }
        } else {
            mShadowDrawable = null;
        }
        ...
        setFadeOnClickListener(new OnClickListener() {
            @Override
     ...
     * not provided, the clicks on the dimmed area are passed through to the main include_review_order_content.
     * @param listener
     */
    ...
    /**
     * Set the scrollable child of the sliding include_review_order_content. If set, scrolling will be transfered between
     ...
     *                    starting from the top of the include_review_order_content.
     */
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (childCount != 2) {
            throw new IllegalStateException("Sliding up panel include_review_order_content must have exactly 2 children!");
        }
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            // Always include_review_order_content the sliding view on the first include_review_order_content
