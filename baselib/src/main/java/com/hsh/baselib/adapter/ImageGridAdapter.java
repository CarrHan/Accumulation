...
import com.hsh.baselib.widget.mutiPicturePicker.ImageDisplayer;
	...
	public View getView(int position, View convertView, ViewGroup parent)
	{
		...
		if (item.isSelected)
		{
			mHolder.selectedIv.setImageDrawable(mContext.getResources()
					.getDrawable(R.mipmap.checkbox_red));
		...
		else
		{
			...
			mHolder.selectedBgTv.setBackgroundResource(R.color.txtColorGrey);
		}
