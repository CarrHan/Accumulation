 ...
 */
public abstract class BaseListRefreshFragment extends BaseNoPresenterFragment implements IBaseRefreshView {
    ...
    // Adapter
    protected MultiItemTypeAdapter commonAdapter;
    ...
    protected void initialize() {
        ...
        recyclerView=(RecyclerView) mContentView.findViewById(R.id.recycleView);
